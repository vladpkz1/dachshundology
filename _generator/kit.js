...
const C = {
  green:'#1E4032', greenDk:'#14291F', greenLt:'#2E5A46',
  cream:'#F6F1E4', sand:'#E6DCC6', paper:'#FBF8EF',
  camel:'#B07D4A', brass:'#C2A24C', oxblood:'#7A2E2A',
  ink:'#1A1A16', slate:'#6F6A5C', navy:'#1F3050'
};
