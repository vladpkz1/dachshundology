...
author: {
  ...
  paras: [
    ...
    'This started as a reading list, not a book. I had three questions about a dachshund — what a disc episode actually costs in America, whether the furniture ban does anything, and when to spay a female of this breed. A month later I had forty tabs open and no answer I would have put my name to.',
    ...
    'The paid material fails differently. Most dachshund books sold in America are written by nobody in particular and read like the blogs with a cover price. The serious exception is narrow by design: the best English-language book on disc disease is British, and written for the owner of a dog already diagnosed. That is one chapter of an ownership, not the whole of it.',

    'And the research does exist. It is simply not here. DachsLife 2015 put questions to the owners of 2,031 dachshunds and was analyzed at the Royal Veterinary College. The lifetime risk figures come from Swedish insurance records. The radiographic back-scoring schemes are Danish and British. Almost none of it reaches an American owner, and the fragments that do arrive stripped of the caveats that made them worth reading.',
    ...
    'The same rule means the gaps are printed rather than papered over. There is no American epidemiological dataset on dachshund disc disease. Every prevalence figure in Part V is Swedish, British or Danish, and the text says so each time instead of passing it off as yours. Where a figure could not be verified, it is not in the book.',
...
howto: {
  ...
  modules: [
    ...
    ['Note', 'The sand panel. Practical detail that would slow the main text down, and the place where British and American practice are separated for readers on either side.'],
  ...
  levels: [
    ['Settled', 'A named body or a body of evidence agrees, and no serious counter-position exists. You can act on it without hedging. Example: leptospirosis moved to the core vaccine list in 2024, for all dogs regardless of size.'],
...
faq: [
  ...
  /* — cost and insurance — */
  { q: 'How much does IVDD surgery cost in the US?',
    a: 'One specialty neurology practice quotes 10,000 to 15,000 dollars all in — consult, imaging, surgery, three or four nights and rehabilitation. PetMD puts the surgical procedure alone at 3,000 to 8,000 dollars, and a diagnostic MRI averages 2,285 dollars nationally. Section 5.6 breaks the bill into its parts.' },

  { q: 'How much does a dachshund puppy cost?',
    a: 'Roughly 1,000 to 3,000 dollars from a reputable breeder, 500 to 2,000 from an online marketplace, 1,800 to 4,000 or more from a pet store, and 200 to 500 from rescue. Dapple adds 500 to 1,000 dollars. Note the overlap: price alone cannot tell a breeder from a broker. Section 2.2.' },

  { q: 'Is pet insurance worth it for a dachshund?',
    a: 'The arithmetic is unusually clear in this breed. The average US dog accident-and-illness premium was 749.29 dollars a year, or 62.44 a month, in NAPHIA’s 2025 report on 2024 data. Set that against a 10,000 to 15,000 dollar surgical episode. Buy it before anything appears on the record. Section 6.9.' },

  { q: 'Does pet insurance cover IVDD?',
    a: 'Modern accident-and-illness policies generally do cover hereditary and breed-linked conditions including IVDD, provided no signs or diagnosis predate the coverage. One published claim example: an 8,500 dollar bill reimbursed at 6,550 with 80 percent coverage and a 250 dollar deductible. The exclusions that matter are in the waiting periods. Section 6.9.' },

  { q: 'How long is the waiting period on pet insurance?',
    a: 'Longer than the fourteen days you were quoted. At least one major insurer applies a 180-day waiting period to orthopedic conditions and classifies IVDD as orthopedic. An orthopedic exam inside the first fourteen days collapses it. The trap alongside it: the NAIC model act counts signs seen “during any waiting period” as preexisting. Section 6.9.' },

  /* — food and weight — */
  { q: 'How much should I feed my dachshund?',
    a: 'Start from resting energy requirement — 70 multiplied by body weight in kilograms to the power 0.75 — then apply a factor: 1.6 for a neutered adult. An 11 lb dog lands near 375 kcal a day, a 16 lb dog near 482, a 25 lb dog near 678. Individual variation runs to plus or minus 50 percent. Section 6.3.' },
  ...
  { q: 'What health tests should a dachshund breeder have done?',
    a: 'The AKC parent-club list for the breed is short: patella evaluation, cardiac exam, ophthalmologist evaluation. That is the whole list. Useful DNA tests beyond it include PRA, degenerative myelopathy and — for miniature wirehaireds — Lafora disease. Check current requirements directly at ofa.org. Section 2.4.' },

  { q: 'Is it safe to buy a dachshund puppy online?',
    a: 'It is where the fraud lives. BBB Scam Tracker logged 2,278 puppy scam reports in 2024 with a median loss of 680 dollars, and cites FTC data that only 4.8 percent of fraud victims report at all. Photos, videos and video calls do not count as seeing a dog. Section 2.1.' },

  { q: 'What are my rights if the puppy turns out to be sick?',
    a: 'Twenty-two states have puppy lemon laws, typically giving a short window for infectious illness and a longer one for congenital defects — California is 15 days and one year, Florida 14 days and one year, Illinois 21 days, Vermont 7 days. They bind dealers, not every hobby breeder, and remedies are usually capped at the purchase price. Section 2.5.' },

  /* — color and coat — */
  { q: 'What is a tweenie dachshund?',
    a: 'A nickname with no official standing anywhere. The AKC recognizes two weight divisions — Standard at usually 16 to 32 pounds, and a Miniature class division for dogs 11 pounds and under at 12 months. The FCI uses chest circumference at 15 months and recognizes three sizes. A “tweenie” is simply a dog between them. Section 1.2.' },
  ...
  { q: 'When should I spay or neuter my dachshund?',
    a: 'This is the one place the guidance genuinely conflicts. AAHA advises castration at six months and spaying before the first heat for dogs under 45 lb. Dorn and Seath, on 1,073 dachshunds, found a relative risk of 2.12 for females spayed before twelve months, with no significant difference after. Section 5.3 sets them side by side.' },
  ...
  { q: 'Can I fly with my dachshund in the cabin?',
    a: 'A miniature generally fits, a standard generally does not. Major US carriers cap the in-cabin carrier at roughly 17 to 18.5 inches long, and most have dropped explicit weight limits, so length decides it. That is reasoning from published dimensions, not an airline statement about the breed — re-check before booking. Section 7.6.' },
...
/* ─────────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────────── */
toxic: {
  intro: 'These are the doses the Merck Veterinary Manual gives for the toxic principle, not for the food it sits in — which is why the type of chocolate matters more than the size of the bar. The worked example throughout is a 16 lb dachshund, which is 7.3 kg, sitting in the middle of the standard range. Scale it for your own dog before you need it, write the number on the fridge, and call poison control before you drive rather than from the parking lot.',
  rows: [
    ['Milk chocolate',
...
glossary: [
  ...
  ['AAFCO', 'The Association of American Feed Control Officials, which writes the nutrient profiles and feeding-trial protocols used on pet food labels but has no regulatory authority and approves nothing.'],
  ...
  ['AKC', 'The American Kennel Club, the principal US registry — it writes the breed standard, runs events and operates breeder programs, and it classifies dachshunds by weight into two divisions.'],
  ...
  ['USDA licensed breeder', 'A breeder required to hold a federal license because they keep more than four breeding females and sell sight-unseen; anyone selling face to face is exempt at any scale, so the license marks commercial volume rather than quality.'],
  ['Lemon law', 'A state pet purchaser protection act giving a buyer a remedy — refund, exchange or veterinary reimbursement — when a puppy is found ill or defective within a set window; twenty-two states have one.'],
  ...
  ['Waiting period', 'The interval after purchase during which a new policy pays nothing for a given category; illness waits are usually short, but at least one insurer applies 180 days to orthopedic conditions and classifies IVDD among them.'],
...
/* ─────────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────────── */
contacts: [
  ['Emergency', 'ASPCA Animal Poison Control Center',
  ...
  ['Registries and standards', 'Dachshund Club of America',
   'dachshundclubofamerica.org · colors and patterns at dachshundclubofamerica.org/wp-content/uploads/2022/02/Dachshund-Colors-and-Patterns.pdf. The parent club, and the authority to quote back at a seller pricing a double dapple as a rarity.'],

  ['Health screening', 'Orthopedic Foundation for Animals',
   'ofa.org. Search a named dog before you buy and confirm the parent-club screens directly — do not accept a printed list from a breeder or from any book, including this one.'],
  ...
  ['Preventive care', 'American Animal Hospital Association',
   'aaha.org/resources/2022-aaha-canine-vaccination-guidelines/. The canine vaccination guidelines your veterinarian is working from — check what core means this year before you decline anything.'],

  ['Preventive care', 'American Heartworm Society',
   'heartwormsociety.org/heartworms-in-dogs. Heartworm is diagnosed in all fifty states; this is where the year-round prevention and the six-month, twelve-month, annual testing schedule come from.'],
  ...
  ['Rescue and rehoming', 'Dachshund Rescue of North America',
   'drna.org/Adoption_Process. National placement network; adoption fees run $350 under a year, $275 for one to seven years, and $150 for eight and over.'],

  ['Rescue and rehoming', 'Coast to Coast Dachshund Rescue',
...
answers: [
  { part: 'I', items: [
    'The AKC sorts by <strong>weight</strong> into two: Standard at usually 16 to 32 pounds, and a Miniature class division for dogs 11 pounds and under at 12 months. The FCI sorts by <strong>chest circumference at 15 months</strong> into three — Standard, Miniature and Rabbit. There is no rabbit size in America and no tweenie anywhere.',
  ...
  { part: 'II', items: [
    'That she sells sight-unseen and at volume. Breeders with four or fewer breeding females are exempt from licensing, and so is anyone who sells face to face at any scale; needing the license means neither exemption applies.',
    'Whether you can see the puppy with its mother at the place it was whelped. Price cannot separate them — the breeder band of $1,000 to $3,000 overlaps the marketplace band of $500 to $2,000 across most of the range.',
    '93 percent of dachshunds carry two copies of the CDDY variant and the allele frequency is 0.98, so the test cannot rank dogs and Dachshund Health UK advises against using it for selection. There is also no US dataset that could establish an IVDD-free line.'
  ]},

  { part: 'III', items: [
    'Under 0.4 of an ounce. Baker’s chocolate carries 440 mg of theobromine per ounce against 64 mg in milk chocolate, and the mild-GI threshold is 20 mg/kg for a 7.3 kg dog. Call poison control with the wrapper in your hand before you drive.',
  ...
  { part: 'VII', items: [
    ...
    'US in-cabin carriers cap at roughly 17 to 18.5 inches long and most airlines have dropped weight limits, so length decides it and a standard generally does not fit. That is arithmetic from published carrier dimensions, not an airline statement — re-check before booking.'
  ]},
