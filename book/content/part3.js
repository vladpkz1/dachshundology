/* DACHSHUNDOLOGY — PART III · The First Thirty Days
   17 pages · sections 3.1 – 3.7 · Tools 7–10 */
...
{
  id:'3.1',
  title:'What to buy, what to skip',
  sub:'the list is shorter than the store thinks',
  pages:3,
  blocks:[
    ...
    {t:'check',title:'Essential — have it in the house before he is',items:[
      ...
      'Two sets of crate bedding you can wash hot.',
      'An exercise pen, or one baby gate, to make a single safe room.',
      'Two flat-bottomed bowls.',
      'Four weeks of the exact food he is eating at the breeder or rescue.',
      'Enzymatic cleaner. Buy the large bottle. You will use the large bottle.',
      'An ID tag engraved with your cell number.',
    ...
    {t:'matrix',title:'Essential — and where the money goes',head:['Item','Verdict','Relative outlay'],rows:[
      ...
      ['Bedding, two washable sets','Essential','Moderate'],
    ...
    {t:'matrix',title:'Useful, and the lines to leave in the store',head:['Item','Verdict','Relative outlay'],rows:[
      ...
      ['Long line, 15–20 ft (4.5–6 m)','Useful','Low'],
      ['Rug runners for slick floors','Useful','Moderate to high, by area'],
    ...
    {t:'photo',n:30,note:'Flat lay on oak: harness, flat leash, soft carrier, two bowls, enzymatic cleaner, folded blanket. Warm side light, shot from directly above, nothing branded.',caption:'The whole essential kit, photographed at actual scale. It fits on a kitchen table.'}
  ]
},
...
{
  id:'3.2',
  title:'Dachshund-proofing the house',
  sub:'do this on your knees',
  pages:3,
  blocks:[
    ...
    {t:'note',title:'The two cupboards people forget',paras:[
      ...
      'Move the guest handbag too. Say it out loud when people arrive, because they will not think of it.'
    ]},
    ...
    {t:'check',title:'Before he comes through the door',items:[
      'Runners down on every slick route he will take at speed.',
      'Gates fitted top and bottom of the stairs, and tested.',
      'Fence line walked at ground level; gaps under gates closed.',
      'Cocoa mulch removed from beds and pots.',
      'Cord covers fitted; trash cans lidded or behind a door.',
      'Baking chocolate, sugar-free gum and chewable vitamins moved above counter height.',
      'Houseplants checked against the ASPCA list.',
      'Your poison line and your overnight clinic, on the refrigerator and in two phones.',
      'One room chosen and cleared as his first room.'
    ]},

    {t:'script',text:'lie down on the kitchen floor. it is embarrassing and it works'},

    {t:'photo',n:31,note:'Low camera, six inches (15 cm) off the floor, looking down a hallway toward a lit kitchen — cord cover, rug runner, gate at the far end all visible in one frame. Shallow depth of field, no dog in shot.',caption:'The house at his eye level. Everything interesting is down here.'}
  ]
},
...
{
  id:'3.3',
  title:'Day one, night one',
  sub:'nobody sleeps, and that is the plan',
  pages:3,
  blocks:[
    ...
    {t:'script',text:'day three is worse than day one. day eight is fine'},

    {t:'photo',n:32,note:'Night shot, available light only: crate on a low table beside a bed, door ajar, a hand hanging over the edge of the mattress near the bars. Grainy is fine. No flash.',caption:'Night one. The crate goes where he can hear you.'}
  ]
},
...
{
  id:'3.4',
  title:'Housetraining in three weeks',
  sub:'you are training yourself, mostly',
  pages:3,
  blocks:[
    ...
    {t:'evidence',badge:'settled',paras:[
      ...
      'The broader case against aversive methods is not sentimental either. Dogs trained in aversive-method schools showed 55.9 lip licks per session against 4.1 in reward-based schools, salivary cortisol of 0.26 against 0.13, and a more pessimistic cognitive bias measured outside the training context entirely. The AVSAB position is unambiguous: reward-based methods only, including for behavior problems.'
    ],source:'VCA house-training guidance; Vieira de Castro et al., PLOS ONE 2019; AVSAB Humane Dog Training Position Statement 2021'},

    {t:'evidence',badge:'myth',paras:[
      'You will be told dachshunds are impossible to housetrain. The kernel of truth is real: in C-BARQ data covering 8,301 dogs across 49 breeds, reported problem behaviors — house-soiling among them — rose as height fell, and the effect was strong (p&lt;0.001).',
      'The explanation is where the myth breaks. A small dog holds a small bladder, so the same interval that suits a retriever asks more of him. A dog eight inches (20 cm) off the ground gets his belly wet in long grass and cold snow — the AVMA names this body type specifically — so he turns around at the door on a wet winter morning. And an 11 lb (5 kg) puddle gets mopped rather than investigated, so the schedule never gets fixed. Arhant and colleagues tie the whole small-dog effect to owner behavior: less shared activity, less consistency, more punitive methods.',
      'None of that is a defect of the breed. All of it is fixable by the person holding the leash — which is the good news, delivered slightly rudely.'
    ],source:'Serpell & Hsu C-BARQ analysis, 8,301 dogs / 49 breeds; Arhant et al. 2010; AVMA cold-weather guidance'},
    ...
    {t:'photo',n:33,note:'The log sheet itself, taped to a refrigerator door, half filled in with two different handwritings and a magnet holding one corner. Kitchen light, slightly worn paper.',caption:'The single sheet that does most of the work. Everyone writes on it.'},
...
{
  id:'3.5',
  title:'Teaching him to be alone',
  sub:'absence is a skill, and week one is when you start it',
  pages:2,
  blocks:[
    ...
    {t:'evidence',badge:'contested',paras:[
      ...
      'We are not going to pick one. The gap is mostly definitional. A large owner questionnaire counts dogs whose owners report a defined behavior crossing a threshold; the higher figures circulate without a consistent primary citation and tend to sweep in any behavior seen when a dog is alone, including boredom, barking at the mail, and one chewed shoe. Sampling differs too — general populations look different from behavior clinics.',
      'What both numbers agree on is that this is common enough to plan for and far from inevitable. The practical stance: assume it is preventable, spend ten minutes a day in week one preventing it, and take it seriously if it appears. Behavior problems remain the leading cause of death in dogs under three years old.'
    ],source:'Salonen et al., Scientific Reports 2020, 13,715 dogs'},
    ...
    {t:'flag',title:'When this stops being a training problem',paras:[
      'Destruction concentrated at doors and windows. Self-injury — bloodied nails, broken teeth on a crate. House-soiling in a dog who is otherwise reliable. Refusing food the entire time you are gone. Drooling that soaks the bedding.',
      'This is panic, not boredom, and it does not respond to more practice or to a longer walk. Stop the protocol, stop leaving him alone while you arrange cover, and book a veterinary behavior consultation. Early cases resolve far more often than late ones.'
    ]},

    {t:'script',text:'ten minutes a day now, or a year of it later'}
  ]
},
...
{
  id:'3.6',
  title:'The first four weeks, planned',
  sub:'one page, stuck to the refrigerator',
  pages:1,
  blocks:[
    ...
    {t:'table',head:['','Health','Socialization','Training & sleep'],rows:[
      ...
      ['Week 2','Leptospirosis: core since 2024 under AAHA, two doses 2–4 weeks apart from 12 weeks — ask which vaccines are core where you live. Year-round parasite prevention; under 7 months, heartworm cover starts without a test.','Puppy class — AVSAB endorses classes from 7 to 8 weeks with one vaccination at least 7 days prior, and says socialization should not wait for the full series.','Sit, hand-target, harness conditioning. One minute at a time, five times a day.'],
      ['Week 3','Next DAPP dose if due. Weigh him and write it down. Ask about rabies timing — the rule is local rather than universal, and the first dose commonly lands between 3 and 6 months.','New surfaces, new sounds, a car ride ending somewhere pleasant. Keep it short; let him retreat.','Recall from three feet (1 m). Handling: ears, feet, mouth — paid every time.'],
      ['Week 4','Stool check. Open the spay or neuter conversation — do not book it yet. Part V sets out why the dachshund-specific evidence sits awkwardly against the general small-dog guidance.','Two or three new people a week, on his terms. Stairs one at a time, on a leash.','Ten to fifteen minutes of structured work a day, split small. The rest is nose and sleep.']
    ],note:'Vaccine intervals: AAHA 2022 guidelines, updated 2024. Parasites: CAPC. Socialization: AVSAB — all written for one market.'},

    {t:'brief',title:'On exercise in month one',paras:[
      'You will be told five minutes per month of age, twice a day. It is a reasonable rule of thumb with no traceable primary source — nobody has one. Use it as a ceiling on forced walking, not as a law. A tired puppy in this breed is made by his nose, not his legs.'
    ]},

    {t:'script',text:'week two is the one people let slide. it is the expensive one'}
  ]
},
...
{
  id:'3.7',
  title:'House rules everyone keeps',
  sub:'the dog is consistent. be more consistent',
  pages:2,
  blocks:[
    ...
    {t:'table',head:['The question','Our answer','Agreed by'],rows:[
      ...
      ['Bed at night?','',''],
      ['Who does the first outing, and at what time?','',''],
      ['Who does the night outing this week?','',''],
      ['Food from the table — ever?','',''],
      ['Which word means “get off”? (one word, one meaning)','',''],
      ['Who logs outings and accidents?','',''],
      ['How is he picked up — one hand under the chest, one under the hindquarters?','',''],
      ['Visitors: who greets him, and when?','',''],
      ['Treat jar: who fills it, what is the daily allowance?','','']
    ],note:'Fill it in with a pen, not in conversation. The unfilled rows are the arguments you have not had yet.'},

    {t:'photo',n:34,note:'A kitchen table, four hands, one sheet of paper between them, a pen mid-sentence. Faces cropped out. Late afternoon light, domestic and unposed.',caption:'Twenty minutes, before the dog arrives. It is the cheapest training session of the year.'},

    {t:'script',text:'the person breaking the rule is always the one who loves him most'},

    {t:'remember',items:[
      ['Harness, never a collar, on the leash','A collar sends the whole force of a lunge through the neck of a breed in which 6% of disc cases are cervical. The switch costs nothing and is permanent.'],
      ['Every one to two waking hours','Housetraining is a schedule, not a lesson. Eight to twelve weeks accident-free before you widen his freedom, and night outings possibly to five months.'],
      ['The first night is bad, and it is normal','Crate beside the bed, outings dull and silent, return into quiet rather than into noise. By day eight it is a different animal.'],
      ['Absence is built, starting day three','Ten minutes a day in seconds and minutes. Separation-related behavior runs at 6% in the largest survey and 20–30% in popular writing; prevention is cheap either way.'],
      ['One phone number, before the dog','In the US, ASPCA APCC (888) 426-4435 or Pet Poison Helpline (855) 764-7661, both fee-charging. Elsewhere, find your own line and store it now.']
    ]},

    {t:'quiz',items:[
      'Your 16 lb (7.3 kg) dachshund gets into the baking cupboard and eats unsweetened baker’s chocolate. How much does it take to reach the dose at which Merck lists mild GI signs — and what do you do first?',
      'He has been clean in the house for three straight weeks. Do you give him the run of the downstairs?',
      'You buy a ramp to the sofa. True or false: you have reduced his risk of disc disease.'
    ],answers:[
      'Under 0.4 of an ounce (11 g). Baker’s chocolate carries 440 mg of theobromine per ounce against 64 mg in milk chocolate, and the mild-GI threshold is 20 mg/kg — a 16 lb dog is 7.3 kg. Call your poison line before you drive — in the US, ASPCA APCC (888) 426-4435 — with the wrapper in your hand.',
      'No. The benchmark is eight to twelve weeks with no accidents, and then one room at a time. Three clean weeks means the schedule is working, not that the dog is finished.',
      'False, or at least unproven. Buy the ramp for his joints, your back and your carpet. The only lifestyle data on this breed — DachsLife, 2,031 owners — found dogs prevented from using furniture reported higher disc risk, and stair use a protective trend that never reached significance. Part V takes it apart properly.'
    ]}
  ]
}
