/* ═══════════════════════════════════════════════════════════════
   PART VIII — THE OLDER DACHSHUND
   Sections 8.1 – 8.5 · 7 pages
   ═══════════════════════════════════════════════════════════════ */
...
{ id:'8.1', title:'What changes after eight', sub:'old is not a diagnosis', pages:2, blocks:[
  ...
  {t:'evidence',badge:'contested',paras:[
    'Owners of older dachshunds are braced for disc disease as though the risk climbs with every year. For the acute, dramatic version of it, the data point the other way.',
    'Degeneration in this breed starts early — around four months, with most discs changed by a year — and the consequences arrive early too. The ACVS puts typical presentation for chondrodystrophoid breeds at <strong>three to six years</strong>, and <strong>76% of cases are diagnosed between four and eight</strong>.',
  ...
  {t:'flag',title:'Sudden is still sudden',paras:[
    ...
    'Do not wait for morning to see if it settles. Confine him, do not let him jump, and call.'
  ]},

  {t:'photo',n:48,note:'Gray-muzzled longhaired dachshund asleep on an orthopedic bed in a shaft of afternoon light, close crop on the face and forepaws.',caption:'Past six, the disc window is largely behind him. What is in front of him is weight, warmth and the stairs.'}
]},
...
{ id:'8.2', title:'Adapting the house, the walk, the bowl', sub:'change the shape of the day, not the amount of it', pages:1, blocks:[
  ...
  {t:'note',title:'The case for keeping him lean',paras:[
    ...
    'A body condition score of 7 out of 9 is roughly 30% body fat. That is not a cosmetic problem on a dog who has to get his own chest off the floor.'
  ]}
]},
...
{ id:'8.3', title:'Spotting pain early', sub:'he will not tell you, he will just do less', pages:1, blocks:[
  ...
  {t:'signals',title:'Eight signs, each one easy to explain away alone',items:[
    ...
    'A shorter fuse: growling when lifted, when touched over the back, or when another dog crowds him',
  ...
  {t:'check',title:'The monthly five minutes',items:[
    ...
    'Run both hands down the topline and over the hindquarters — lumps, flinching, thinning muscle',
    'Lift each foot, flex each hind leg gently, watch his face, not the leg',
    'Lift the lip on both sides: gum color, tartar, a broken tooth, odor',
    'Film thirty seconds of him walking away from you and back, on the same floor, in the same light',
...
/* ───────────────────────── 8.5 ───────────────────────── */
{ id:'8.5', title:'What to remember', sub:'the last five things, and three questions', pages:1, blocks:[

  {t:'remember',items:[
    ['Age is not a diagnosis','Two veterinary visits a year from about eight, with annual bloodwork. “He’s just getting old” is where a painful tooth, a sore joint and a treatable disease all go to hide.'],
    ['The disc window is largely behind him','76% of IVDD cases are diagnosed between four and eight, and chondrodystrophoid breeds typically present at three to six. An eight-year-old with a clean record is past the middle of it — but an acute episode at nine is still an emergency at nine.'],
    ['Keep the total, change the shape','Three short outings beat one long one. Traction and a ramp, not a ban on the furniture: the survey evidence on dogs prevented from using it points the other way.'],
    ['Lean is the lever you still have','RER is 70 × kg^0.75; a 16-pound (7 kg) dog at the neutered-adult factor lands near 482 kcal a day. Steer for a body condition score of 4 to 5. A 25% calorie restriction added about 1.8 years of median lifespan in 48 Labradors.'],
    ['Chronic pain is quiet','He will not limp and cry. He will do less, hesitate at steps, sleep somewhere flatter and shorten his fuse. Weigh him monthly, film thirty seconds of him walking, and ask your veterinarian the direct question.']
  ]},

  {t:'quiz',items:[
    'Your nine-year-old has stopped jumping onto the couch and sleeps more. Your neighbor says he is just getting old. What is wrong with that, and what do you actually do this month?',
    'You are told to block him off the furniture permanently now that he is elderly. What does the survey evidence say, and what is the better version of that plan?',
    'How do you make the last decision well, and what makes it go badly?'
  ],answers:[
    'Age explains nothing on its own, and a new reluctance is a clinical finding. Rule out pain first — dental disease and joints are the usual culprits and both are treatable. This month: weigh him, run your hands over the topline and hindquarters, lift the lip, film him walking away and back, and book a veterinary visit with the clips and the direct question, “is he in pain?”',
    'DachsLife found dogs prevented from using furniture were at higher risk of disc disease, not lower — so a blanket ban has no support behind it. The better plan is a controlled route: a low, wide, grippy ramp taught with food, a lower bed, runners on the floors he uses, and short nails so he can land without slipping.',
    'Well: ask your veterinarian for a quality-of-life scale, score it weekly and write it down, and set your limits in plain language on an ordinary afternoon — three bad days in a row, he stops eating what he loves, he cannot get outside to eliminate. Badly: making it for the first time at eleven at night in an emergency room, exhausted, with no scale, no record and no limits agreed in advance.'
  ]}
]}
